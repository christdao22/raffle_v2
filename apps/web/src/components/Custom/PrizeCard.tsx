  ...
  return (
    <div className={cn("prize-rotating-border", className)}>
      <div className="relative overflow-hidden rounded-[calc(1rem-3px)] bg-tr-surface-container-lowest">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-[1fr_1.15fr] items-center gap-6 p-8 pt-18">
          {/* Prize details */}
          <div className="space-y-5">
            ...
            {/* Sponsor */}
            <div className="pt-2">
              <p className="font-sans text-xs font-bold uppercase tracking-[0.16em] text-tr-primary">
                Sponsored by
              </p>
