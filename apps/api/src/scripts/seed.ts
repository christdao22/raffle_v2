...
async function main() {
  ...
  const prizeValues = [
    ...
    },
    {
      ...
      sponsorImage: "/ja philippines.png",
      numberOfWinners: 1,
      type: "Minor",
      raffleMode: "Pre-draw",
      deletedAt: null,
